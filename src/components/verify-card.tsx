        ...
        <div className="p-8 pb-10 relative">
          ...
          <div className="text-center relative z-10">
             <div className="inline-flex items-center gap-2 mb-8 bg-slate-50 border border-slate-100 px-4 py-1.5 rounded-full">
                ...
                <span className="text-xs font-bold text-slate-600 tracking-wide uppercase">Official Warranty Certificate</span>
             </div>
          ...
          <div className="bg-slate-50/80 rounded-2xl border border-slate-100 p-1 relative z-10">
             <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100/50 space-y-5">
                ...
                <div className="flex items-start gap-4 pb-5 border-b border-slate-100">
                    ...
                    <div>
                        <div className="text-[10px] font-bold text-indigo-500 uppercase tracking-wider mb-0.5">Authorized Partner</div>
          ...
          <div className="mt-8 flex items-end justify-between relative z-10">
              <div className="text-left">
                  <div className="text-[10px] uppercase font-bold text-slate-400 mb-2 tracking-widest">Authenticity Verified By</div>
