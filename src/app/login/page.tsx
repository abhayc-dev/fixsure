...
export default function LoginPage() {
  ...
  return (
    <div className="h-[100dvh] bg-[#FFFBF9] relative flex flex-col overflow-hidden w-full">
      {/* Dynamic Background Blobs */}
      <div className="absolute top-0 -left-20 w-[600px] h-[600px] bg-orange-200/30 rounded-full blur-[120px] pointer-events-none -z-0"></div>
      <div className="absolute bottom-0 -right-20 w-[500px] h-[500px] bg-blue-100/40 rounded-full blur-[100px] pointer-events-none -z-0"></div>
      ...
      <div className="flex-1 overflow-y-auto relative z-10 flex min-h-full p-4 items-center justify-center">
